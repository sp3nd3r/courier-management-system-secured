...
// Login is issued from here, so the session cookie must be created with the
// hardened flags rather than PHP's defaults.
secure_session_start();

// include_once: update.php now pulls in add.php for hash_password(), so a plain
// include would load add.php a second time and redeclare its functions.
include_once __DIR__ . '/inc/get.php';
include_once __DIR__ . '/inc/connection.php';
include_once __DIR__ . '/inc/update.php';
include_once __DIR__ . '/inc/delete.php';
include_once __DIR__ . '/inc/add.php';
